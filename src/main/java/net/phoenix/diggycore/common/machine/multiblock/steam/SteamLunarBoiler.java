package net.phoenix.diggycore.common.machine.multiblock.steam;
...
public class SteamLunarBoiler extends SteamBoilerMachine {

    public SteamLunarBoiler(IMachineBlockEntity holder, boolean isHighPressure, Object... args) {
    ...
    protected long getBaseSteamOutput() {
        return isHighPressure ? ConfigHolder.INSTANCE.machines.smallBoilers.hpSolarBoilerBaseOutput / 2 :
                ConfigHolder.INSTANCE.machines.smallBoilers.solarBoilerBaseOutput / 2;
    }
    ...
    public ModularUI createUI(Player entityPlayer) {
        return super.createUI(entityPlayer)
                .widget(new ProgressWidget(() -> !GTUtil.canSeeSunClearly(getLevel(), getPos()) ? 1.0 : 0.0, 114, 44,
                        20,
                        20)
                        .setProgressTexture(
